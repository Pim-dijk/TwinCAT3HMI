...
Public Class FormingMold_Manual
    ...
    Private Sub FormingMold_Manual_ParentChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ParentChanged
