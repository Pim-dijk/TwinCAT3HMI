...
Public Class FormingMold_Overview
    ...
    Private Sub FormingMold_Overview_ParentChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ParentChanged
    ...
    Private Sub Btn_Settings_Click(sender As Object, e As EventArgs) Handles Btn_Settings.Click
        frmMain.SubFormChange(frmMain.SubFormingMold_Settings)
    End Sub
