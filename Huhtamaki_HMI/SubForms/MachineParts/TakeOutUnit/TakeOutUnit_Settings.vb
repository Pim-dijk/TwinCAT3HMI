...
Public Class TakeOutUnit_Settings
    ...
    Private Sub InitControls()
        ...
        If IsASide Then
            ' Get right title
            frmMain.lblTitle.Text = GetSingleLabel(103)
            strSide = "MoldA"
        Else
            'Get right title
            frmMain.lblTitle.Text = GetSingleLabel(106)
            strSide = "MoldB"
        End If
    ...
    Private Sub TakeOutUnit_Settings_ParentChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ParentChanged
