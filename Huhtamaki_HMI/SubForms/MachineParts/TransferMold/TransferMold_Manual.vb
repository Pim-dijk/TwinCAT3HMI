...
Public Class TransferMold_Manual
    ...
    Private Sub TransferMold_Manual_ParentChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ParentChanged
