...
Public Class Gantry_Manual
    ...
    Private Sub InitControls()
        ...
        If IsASide Then
            ' Get right title
            frmMain.lblTitle.Text = GetSingleLabel(602)
            strSide = "GantryA"
        Else
            'Get right title
            frmMain.lblTitle.Text = GetSingleLabel(603)
            strSide = "GantryB"
        End If
    ...
    Private Sub Gantry_Manual_ParentChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.ParentChanged
