...
Partial Class SpeedControl_Manual
    ...
    Private Sub InitializeComponent()
        ...
        Me.CON_ManFwd.VariableName = "MAIN.Conveyor.Belt.HMI_Forward"
        '
        'Btn_Fwd
        '
        ...
        Me.CON_ManRev.VariableName = "MAIN.Conveyor.Belt.HMI_Backward"
        '
        'Btn_Rev
        '
