...
Public Class DryingMoldDetail_Bot_Settings
...
#End Region
    ...
    Private Sub SP_MAX_DataChanged(sender As Object, e As EventArgs) Handles SP_MAX.DataChanged, SP_MIN.DataChanged, OUT_MIN.DataChanged, OUT_MAX.DataChanged
        ScalePIDbars()
    End Sub
