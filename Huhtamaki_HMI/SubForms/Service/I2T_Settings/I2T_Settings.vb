...
Public Class I2T_Settings
    ...
    Private Sub Btn_Settings2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'frmMain.SubFormChange(frmMain.SubI2TSettings2)
    End Sub
